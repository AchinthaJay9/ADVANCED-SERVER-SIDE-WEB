...
$config['log_threshold'] = 2; // Set the log threshold level (0 = disabling logging, 1 = errors only, 2 = errors and debug messages)
$config['log_path'] = 'application/logs/'; // Set the log file path
